...
| Kibana     | Graphical upload via Kibana interface (Machine Learning → Data Visualizer → Import Data) | <ul><li>Simple / low code</li><li>GUI, drag&drop</li><li>various formats (including CSV/TSV, Newline delimited JSON)</li><li>Allows live preview of the data including statistics about expression</li><li>Mapping can be edited during import</li></ul> | <ul><li>100MB size limit</li><li>Only works on ES installations with Kibana connected</li><li>Import only into a new index, you would then have to re-index in the second step</li></ul> | 
